...
export const Banner = ({ ...rest }: BannerProps) => {
  return (
    ...
    >
      <h1 className="text-6xl text-left font-bold text-slate-100 absolute self-end font-sans leading-snug mb-10 ml-20 max-sm:text-5xl max-sm:text-center max-sm:self-center max-sm:m-0 max-sm:w-[90%] max-sm:leading-normal">
